...
type PixFmtGrayGamma[PF any, G any] struct {
	pixfmt PixFmtAlphaBlendGray[BlenderGray8, any]
	gamma  G
}

// NewPixFmtGrayGamma creates a new gamma-corrected grayscale pixel format
func NewPixFmtGrayGamma[PF any, G any](pixfmt PixFmtAlphaBlendGray[BlenderGray8, any], gamma G) *PixFmtGrayGamma[PF, G] {
...
type (
	PixFmtGray8Gamma  = PixFmtGrayGamma[PixFmtGray8, *SimpleGammaLut]
	PixFmtGray8Linear = PixFmtGrayGamma[PixFmtGray8, *LinearGammaLut]
)

// Constructor functions for gamma-corrected formats
func NewPixFmtGray8Gamma(pixfmt PixFmtAlphaBlendGray[BlenderGray8, any], gamma float64) *PixFmtGray8Gamma {
	return NewPixFmtGrayGamma[PixFmtGray8](pixfmt, NewSimpleGammaLut(gamma))
}

func NewPixFmtGray8Linear(pixfmt PixFmtAlphaBlendGray[BlenderGray8, any]) *PixFmtGray8Linear {
	return NewPixFmtGrayGamma[PixFmtGray8](pixfmt, NewLinearGammaLut())
}
