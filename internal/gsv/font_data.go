...
// GSVDefaultFont contains the embedded vector font data from AGG's gsv_text.cpp
// This is the default Gouraud Shaded Vector font that supports ASCII characters 32-127.
// The font data format is:
// - Header (64 bytes): font metadata including base height and character table offset
// - Character index table: 16-bit offsets to glyph data for each character (256 entries)
// - Glyph data: vector coordinates for each character as (dx, dy) pairs
var GSVDefaultFont = []byte{
