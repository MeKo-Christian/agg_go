...
// NewVPGenClipPolygon creates a new polygon clipping vertex processor.
...
func (v *VPGenClipPolygon) SetClipBox(x1, y1, x2, y2 float64) {
	v.clipBox.X1 = x1
	v.clipBox.Y1 = y1
	v.clipBox.X2 = x2
	v.clipBox.Y2 = y2
...
func (v *VPGenClipPolygon) X1() float64 {
	return v.clipBox.X1
}

// Y1 returns the bottom edge of the clip box.
func (v *VPGenClipPolygon) Y1() float64 {
	return v.clipBox.Y1
}

// X2 returns the right edge of the clip box.
func (v *VPGenClipPolygon) X2() float64 {
	return v.clipBox.X2
}

// Y2 returns the top edge of the clip box.
func (v *VPGenClipPolygon) Y2() float64 {
	return v.clipBox.Y2
}

// AutoClose returns true indicating polygons should be automatically closed.
func (v *VPGenClipPolygon) AutoClose() bool {
	return true
}

// AutoUnclose returns false indicating polygons should not be unclosed.
func (v *VPGenClipPolygon) AutoUnclose() bool {
	return false
}
