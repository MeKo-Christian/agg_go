...
// VPGenClipPolyline behind ConvAdaptorVPGen so open paths are clipped against a
// rectangle as they stream through the converter.
type ConvClipPolyline struct {
	*ConvAdaptorVPGen[*vcgen.VPGenClipPolyline]
}

// NewConvClipPolyline creates a polyline clipping converter.
